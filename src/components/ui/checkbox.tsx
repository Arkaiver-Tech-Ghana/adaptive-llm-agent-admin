...
// Replaces the bare `<input type="checkbox">` this app used in four
// places. Those rendered the OS's own control — Chrome's blue on a page
// whose accent is indigo — and carried no focus ring of their own.
function Checkbox({
  className,
  ...props
